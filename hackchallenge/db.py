...
# class Task(db.Model): #db is an instance of SQLAlchemy   
#   #a Task is like a Model in our data base
#   #Model is like a blue print of the object/ for a specific row
#   """
#   Task Model
#   """
...
#   subtasks = db.relationship("Subtask", cascade = "delete") #name it of the name of the task
#   #when we delete parenet task, all subtasks would be deleted.
#   categories = db.relationship("Category", secondary = association_table, back_populates = "tasks") # name of the class starts with capital letters and name of the table with lower case letters
# #"task" is a field of Category

#   #give the freedom to input/design the entry in the database / it's possible that user might input more things

#   #** kwargs: 
#   def __init__(self, **kwargs) -> None:  #kwargs: can enter any and turn it into a dictionary    
#     """
#     Initializes a Task object
#     """

#     self.description = kwargs.get("description", "")  #default of "" empty string
...
#     self.description = kwargs.get("description", "")
#     self.done = kwargs.get("done", False)
#     self.task_id = kwargs.get("task_id") # get function would defaul a None object if it doesn't find in the dictionary   
#     #APP.py should check for this
  
#   def serialize(self):
#     """
#     Serialized a subtask object
#     """
